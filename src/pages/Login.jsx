...
const Login =()=>{
  ...
  return(
    <div className="container flex flex-row w-full h-[full] overflow-hidden">
          <div className="flex h-[1024px] w-full flex-col justify-between bg-[#605BFF] p-16">

            <span className=" text-white">
            <div className='bg-white rounded-full w-20 h-20 flex justify-center items-center'><svg width="87" height="30" viewBox="0 0 87 30" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex w-full place-content-center items-center  bg-[#F8FAFF]">
            <div className="flex flex-col gap-7 ">
              <div className="flex flex-col">
                <span className="text-3xl font-bold font-family-montserrat text-black">Sign In</span>
              ...
              <div className="flex flex-row items-center gap-7">
                ...
                <div className="flex flex-row items-center gap-2 rounded-2xl bg-white p-4 text-xs text-[#858585]">
                  ...
                  <span className='cursor-pointer' onClick={() => loginWithRedirect() }>Sign in with Apple</span> 
                </div>
              </div>
              <div className="flex flex-col gap-7 rounded-xl bg-white p-8 shadow-lg">
                <div className="flex flex-col gap-2  text-base font-normal text-black">
                  ...
                  <input
                    ...
                    className=" p-3 rounded-lg border border-[#F5F5F5] bg-[#F5F5F5] text-xs"
                  />
                </div>
                <div className="flex flex-col gap-2 text-base font-normal text-black">
                ...
                <p className=" cursor-pointer text-base font-normal text-[#605BFF]">
                  Forgot password?
                </p>
                <button className="w-[357px] rounded-lg bg-[#605BFF] py-2 text-base font-bold text-white cursor-pointer" onClick={() => loginWithRedirect() }>
                  Sign In
                </button>
